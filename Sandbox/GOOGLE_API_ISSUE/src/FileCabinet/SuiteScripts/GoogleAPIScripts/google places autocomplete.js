...
define(['N/url', 'N/runtime'], function(url, runtime) {
    function pageInit(context) {
        console.log("Google API Code - Page initialized.");
    }

    function fieldChanged(context) {
        console.log('context', runtime.executionContext)
        if (runtime.executionContext == 'USERINTERFACE'){
            if (context.fieldId == 'custbody_pu_location' || context.fieldId == 'custbody_drop_location') { 
